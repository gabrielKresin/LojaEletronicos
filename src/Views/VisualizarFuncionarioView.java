...
public class VisualizarFuncionarioView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "CPF", "Idade", "Sexo", "Email", "Telefone", "Cargo", "Salário", "Bairro", "Rua", "Número", "Complemento"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarFuncionarioView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualizarFuncionarioView().setVisible(true);
            }
        });
    }
